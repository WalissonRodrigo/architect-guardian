...
export class SkillEngine {
  ...
  async executeSkill(
    ...
    try {
      ...
      const promptPath = path.join(skillBasePath, 'prompt.md');
      let output: any;
      ...
      if (await this.exists(promptPath)) {
        ...
        if (context.args.filePath && typeof context.args.filePath === 'string') {
  ...
  findRelevantSkills(stack: ProjectStack, availableSkills: SkillManifest[]): SkillManifest[] {
